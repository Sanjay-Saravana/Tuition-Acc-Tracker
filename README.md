...
- Hardened cloud sync strategy: automatic local+cloud merge when both sides contain data, and no destructive overwrite of non-empty cloud with empty local.
